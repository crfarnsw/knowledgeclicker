...
var User = (function () {
    ...
    Object.defineProperty(User.prototype, "knowledge", {
        get: function () {
            return this.numKnowledge;
        },
        set: function (numKnowledge) {
            this.numKnowledge = numKnowledge;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(User.prototype, "totKnowledge", {
        get: function () {
            return this.totalKnowledge;
        },
        set: function (totalKnowledge) {
...
$('#btnBookUpgrd').on('click', function () {
    bookUpgrade = true;
    player.numKnowledge -= bookUpgradeCost;
});
$('#btnSchoolUpgrd').on('click', function () {
    schoolUpgrade = true;
    player.numKnowledge -= schoolUpgradeCost;
});
$('#btnSchoolUpgrd2').on('click', function () {
    schoolUpgrade2 = true;
    player.numKnowledge -= schoolUpgrade2Cost;
});
$('#btnClickUpgrade1').on('click', function () {
    click1 = true;
    player.numKnowledge -= click1Cost;
});
$('#btnClickUpgrade2').on('click', function () {
    click2 = true;
...
//# sourceMappingURL=PlayerProgress.js.map